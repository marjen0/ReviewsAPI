...
namespace ReviewsAPI.Migrations
{
    ...
    [Migration("20200514150714_TextRole")]
    partial class TextRole
    {
            ...
            modelBuilder.Entity("ReviewsAPI.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            ConfirmedAt = new DateTime(2020, 5, 14, 18, 7, 13, 707, DateTimeKind.Local).AddTicks(4597),
                            Cons = "nėra dalių",
                            CreatedAt = new DateTime(2020, 5, 14, 18, 7, 13, 704, DateTimeKind.Local).AddTicks(2758),
                            IsRecommended = true,
                        ...
                        {
                            Id = 2L,
                            ConfirmedAt = new DateTime(2020, 5, 14, 18, 7, 13, 707, DateTimeKind.Local).AddTicks(5480),
                            Cons = "nėra dalių",
                            CreatedAt = new DateTime(2020, 5, 14, 18, 7, 13, 707, DateTimeKind.Local).AddTicks(5466),
                            IsRecommended = true,
                            Model = "Honda CBR 600",
                            Pros = "Negenda",
                            RegularUserId = 4L,
                        ...
                        {
                            Id = 3L,
                            ConfirmedAt = new DateTime(2020, 5, 14, 18, 7, 13, 707, DateTimeKind.Local).AddTicks(5496),
                            Cons = "nėra dalių",
                            CreatedAt = new DateTime(2020, 5, 14, 18, 7, 13, 707, DateTimeKind.Local).AddTicks(5492),
                            IsRecommended = true,
